...
## はじめに
自分の紹介ページを作りたいとずっと思っていたのですが、時間が取れずに放置していました。
最近は Claude Code や Codex に対話で指示しながら進める Vibe Coding が話題です。ちょうど時間ができたので、自己紹介サイトをこのやり方で作ってみました。
